...
This repository details the code and output of the [2024 ISDRI SDF - NHGIS](https://isrdi.umn.edu/summer-2024-projects) project. This [blog](https://blog.popdata.org/updated-land-cover-summaries/) provides a brief summary if the entire project.
